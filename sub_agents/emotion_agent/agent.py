...
root_agent = Agent(
    ...
    instruction="""You are an expert emotion detection agent with conversation context awareness. Your primary task is to analyze the current user message AND the conversation history to identify the emotions being expressed.
...
Always provide structured responses that can be parsed programmatically while maintaining a human touch in your analysis.""",
    # Configure the agent to use structured output
